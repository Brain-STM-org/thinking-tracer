  ...
  return [
    {
      ...
      thinkingBlocks: [{ text: 'Thinking about the test scenario' }],
      toolUses: [],
      toolResults: [],
      documents: [],
    },
    {
      ...
      thinkingBlocks: [{ text: 'More thinking about quality' }],
      toolUses: [],
      toolResults: [],
      documents: [],
    },
...
describe('getWordFrequencies', () => {
  ...
  it('filters by user source', () => {
    const clusters: SearchableCluster[] = [{
      ...
      thinkingBlocks: [{ text: 'thinkingword' }],
      toolUses: [],
      toolResults: [],
      documents: [],
    }];
  ...
  it('filters by thinking source', () => {
    const clusters: SearchableCluster[] = [{
      ...
      userText: 'userword',
      assistantText: 'assistantword',
      thinkingBlocks: [{ text: 'thinkingword thinkingword' }],
      toolUses: [],
      toolResults: [],
      documents: [],
    }];
